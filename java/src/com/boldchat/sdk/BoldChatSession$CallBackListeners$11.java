    ...
    implements val.unavailableForm
{
    ...
    public void onFormSubmit(Form form)
    {
        ...
        BoldChatSession.access$2800(_fld0, BoldChatState.Finished, BoldChatSession.access$600(_fld0, "api#unavailable#emailed"), BoldChatSession.access$600(_fld0, "api#chat#close"), null, new BoldChatFormView.SubmitListener() {

            final BoldChatSession.CallBackListeners._cls11 this$2;
            ...
            {
                this$2 = BoldChatSession.CallBackListeners._cls11.this;
                super();
            }
        });
    }
