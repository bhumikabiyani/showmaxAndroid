    ...
    implements Runnable
{
    ...
    public void run()
    {
        if (val$brandings != null)
        {
            if (BoldChatViewManager.access$100(BoldChatViewManager.this) != null)
            {
            ...
            if (BoldChatViewManager.access$300(BoldChatViewManager.this) != null)
            {
                BoldChatViewManager.access$300(BoldChatViewManager.this).setTitle(BoldChatSession.getBranding("api#chat#email_transcript", val$brandings, BoldChatViewManager.access$200(BoldChatViewManager.this)));
            }
        }
    }
