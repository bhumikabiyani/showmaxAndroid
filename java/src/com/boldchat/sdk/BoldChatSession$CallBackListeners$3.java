    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        if (BoldChatSession.access$500(_fld0).getEmailTranscriptMenuItem() != null)
        {
            BoldChatSession.access$500(_fld0).getEmailTranscriptMenuItem().setTitle(BoldChatSession.access$600(_fld0, "api#chat#email_transcript"));
        }
