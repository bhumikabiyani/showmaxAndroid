    ...
    implements this._cls2
{
    ...
    // Unreferenced inner class com/boldchat/sdk/BoldChatSession$CallBackListeners$4

/* anonymous class */
    class BoldChatSession.CallBackListeners._cls4
        implements BoldChatFormView.SubmitListener
    {
        ...
        public void onFormSubmit(Form form)
        {
            ...
            BoldChatSession.access$2800(this$0, BoldChatState.Finished, BoldChatSession.access$600(this$0, "api#unavailable#emailed"), BoldChatSession.access$600(this$0, "api#chat#close"), null, new BoldChatSession.CallBackListeners._cls4._cls1());
        }
