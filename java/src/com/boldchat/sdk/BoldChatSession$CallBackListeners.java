...
private class <init>
    implements CreateChatListener, ChatStartListener, ChatFinishedListener, ChatTyperListener, ChatListener, android.view.ers, ChatMessageListener, ChatQueueListener, PostChatSubmitListener, ChatUnavailableListener, edListener
{
...
_L1:
        ...
        Message message;
        for (Iterator iterator = list.iterator(); iterator.hasNext(); BoldChatSession.access$3000(BoldChatSession.this, message, false))
        {
...
_L2:
    ...
    public void onChatCreateFailed(int i, String s)
    {
        ...
        BoldChatSession.access$2700(boldchatsession, s);
    }
    ...
    public void onChatCreated(PreChat prechat, final Chat chat)
    {
        ...
        {
            BoldChatSession.access$2600(BoldChatSession.this, com.boldchat.sdk.BoldChatState.PreChat, BoldChatSession.access$600(BoldChatSession.this, "api#prechat#intro"), "api#prechat#intro", BoldChatSession.access$600(BoldChatSession.this, "api#prechat#start"), "api#prechat#start", prechat, new BoldChatFormView.SubmitListener() {
    ...
    public void onChatFinished(PostChat postchat)
    {
        ...
        BoldChatSession.access$2800(BoldChatSession.this, com.boldchat.sdk.BoldChatState.PostChat, s, BoldChatSession.access$600(BoldChatSession.this, "api#chat#close"), postchat, new BoldChatFormView.SubmitListener() {
    ...
    public void onChatStarted()
    {
        ...
        BoldChatSession.access$2400(BoldChatSession.this, new Runnable() {
            ...
            public void run()
            {
                ...
                if (BoldChatSession.access$500(this$0).getEmailTranscriptMenuItem() != null)
                {
                    BoldChatSession.access$500(this$0).getEmailTranscriptMenuItem().setTitle(BoldChatSession.access$600(this$0, "api#chat#email_transcript"));
                }
    ...
    public void onChatUnavailable(final UnavailableForm unavailableForm)
    {
        ...
        BoldChatSession.access$2800(BoldChatSession.this, BoldChatState.UnavailableChat, BoldChatSession.access$600(BoldChatSession.this, s), BoldChatSession.access$600(BoldChatSession.this, "api#chat#send"), unavailableForm, new BoldChatFormView.SubmitListener() {
            ...
            public void onFormSubmit(Form form)
            {
                ...
                BoldChatSession.access$2800(this$0, BoldChatState.Finished, BoldChatSession.access$600(this$0, "api#unavailable#emailed"), BoldChatSession.access$600(this$0, "api#chat#close"), null, new BoldChatFormView.SubmitListener() {
...
_L1:
        ...
        {
            BoldChatSession.access$2800(BoldChatSession.this, BoldChatState.Finished, BoldChatSession.access$600(BoldChatSession.this, s), BoldChatSession.access$600(BoldChatSession.this, "api#chat#close"), unavailableForm, new BoldChatFormView.SubmitListener() {
    ...
    public void onChatUpdated(Chat chat)
    {
        ...
        {
            BoldChatSession.access$2900(BoldChatSession.this);
...
_L1:
        BoldChatSession.access$3100(BoldChatSession.this);
...
_L5:
    ...
    public void onMessageAdded(final Message message)
    {
        ...
        BoldChatSession.access$3000(BoldChatSession.this, message, false);
    }

    public void onPostChatSubmitFailed(Form form, String s)
    {
        BoldChatSession.access$2800(BoldChatSession.this, BoldChatState.Finished, s, BoldChatSession.access$600(BoldChatSession.this, "api#chat#close"), null, new BoldChatFormView.SubmitListener() {
...
_L4:
        ...
        BoldChatSession.access$2800(BoldChatSession.this, BoldChatState.Finished, form, BoldChatSession.access$600(BoldChatSession.this, "api#chat#close"), null, new BoldChatFormView.SubmitListener() {
...
_L3:
    ...
    {
        BoldChatSession.access$3000(BoldChatSession.this, message, true);
    }
