...
label0:
    ...
    private void setStateMain(BoldChatState boldchatstate, BoldChatFormView boldchatformview)
    {
        ...
        case 7: // '\007'
            ...
            {
                boldchatstate = mEmailTranscriptButton;
                if (mEndChatMenuItem == null)
                {
                    i = ((flag) ? 1 : 0);
                } else
                ...
                boldchatstate.setVisibility(i);
                mEmailTranscriptButton.setEnabled(true);
            }
            showChatMenu(true);
            if (mTypingView != null)
            {
    ...
    public void addMenuItems(MenuInflater menuinflater, Menu menu)
    {
        ...
        mEmailTranscriptMenuItem = menu.findItem(R.id.bc_email_transcript);
        boolean flag;
    ...
    {
        return mEmailTranscriptMenuItem;
    }
        ...
        mMainHandler.post(new Runnable() {
            ...
            public void run()
            {
                if (brandings != null)
                {
                    ...
                    if (mEmailTranscriptMenuItem != null)
                    {
                        mEmailTranscriptMenuItem.setTitle(BoldChatSession.getBranding("api#chat#email_transcript", brandings, mContext));
                    }
                }
            }
    ...
    protected void showChatMenu(boolean flag)
    {
        ...
        if (mEmailTranscriptMenuItem != null)
        {
            mEmailTranscriptMenuItem.setVisible(flag);
        }
    }
