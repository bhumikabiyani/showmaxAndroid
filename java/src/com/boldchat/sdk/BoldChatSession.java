...
_L4:
            ...
            if (mMainView != null)
            {
                ...
                mSession.mViewManager.setMainViewClickListener(R.id.bc_email_transcript, mSession.mCallBackListener);
...
_L5:
        ...
        public Builder setExtraData(Map map)
        {
            mExtraData = map;
            if (map != null)
            {
        ...
        public Builder setListener(BoldChatSessionListener boldchatsessionlistener)
        {
            mListener = boldchatsessionlistener;
            return this;
        }

        public Builder setServerSet(String s)
        {
            mServerSet = s;
            return this;
        }
        ...
        {
            mSession.mSharedPrefs = sharedpreferences;
            return this;
        }

        public Builder setSkipPreChat(boolean flag)
        {
            mSkipPreChat = flag;
            return this;
        }

        public Builder setTimeFormat(DateFormat dateformat)
        {
            mSession.mTimeFormat = dateformat;
            return this;
        }
        ...
        public Builder(BoldChatView boldchatview)
        {
    ...
    private class CallBackListeners
        implements CreateChatListener, ChatStartListener, ChatFinishedListener, ChatTyperListener, ChatListener, android.view.View.OnClickListener, ChatMessageListener, ChatQueueListener, PostChatSubmitListener, ChatUnavailableListener, BoldChatWebHistory.HistoryPageLoadedListener
    {
        ...
        public void onChatStarted()
        {
            ...
            runMain(new Runnable() {
                ...
                public void run()
                {
                    ...
                    if (mViewManager.getEmailTranscriptMenuItem() != null)
                    {
                        mViewManager.getEmailTranscriptMenuItem().setTitle(getBranding("api#chat#email_transcript"));
                    }
...
_L3:
            ...
            if (view.getId() == R.id.bc_email_transcript)
            {
                showEmailTranscriptForm();
                return;
            }
...
_L2:
    ...
    private void showEmailTranscriptForm()
    {
        if (sChat != null)
        {
            final EditText input = new EditText(mContext);
            input.setInputType(0x80021);
            final AlertDialog dialog = (new android.app.AlertDialog.Builder(mContext)).setMessage(getBranding("api#chat#email")).setView(input).setPositiveButton(getBranding("api#generic#ok"), null).setNegativeButton(getBranding("api#generic#cancel"), null).create();
...
label0:
                            {
                                ...
                                if (!TextUtils.isEmpty(view))
                                {
                                    ...
                                    input.setError(getBranding("api#email#error"));
                                }
                                return;
                            }
                            BoldChatSession.sChat.emailChatHistory(view.toString());
                            dialog.dismiss();
                        }
...
_L3:
    ...
    public boolean menuItemSelected(MenuItem menuitem)
    {
        ...
        if (menuitem.getItemId() == R.id.bc_email_transcript)
        {
            showEmailTranscriptForm();
            return true;
        } else
...
/*
    static DateFormat access$1002(BoldChatSession boldchatsession, DateFormat dateformat)
    {
        boldchatsession.mTimeFormat = dateformat;
        return dateformat;
    }
