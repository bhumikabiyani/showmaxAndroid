    ...
    implements BoldChatHistory
{
    ...
    private class JsObject
    {
        ...
        public void pageLoaded()
        {
            ...
            {
                mLoadedListener.historyPageLoaded();
            }
        }
    ...
    private void initView(Context context, AttributeSet attributeset)
    {
        if (!isInEditMode())
        {
            ...
            historyColors.put(Integer.valueOf(0), new HistoryColor(resources.getColor(R.color.bc_history_background), "bc_history_background"));
            historyColors.put(Integer.valueOf(1), new HistoryColor(resources.getColor(R.color.bc_history_visitor_text), "bc_history_visitor_text"));
            historyColors.put(Integer.valueOf(2), new HistoryColor(resources.getColor(R.color.bc_history_visitor_background), "bc_history_visitor_background"));
            historyColors.put(Integer.valueOf(3), new HistoryColor(resources.getColor(R.color.bc_history_visitor_time), "bc_history_visitor_time"));
            historyColors.put(Integer.valueOf(4), new HistoryColor(resources.getColor(R.color.bc_history_visitor_sender), "bc_history_visitor_sender"));
            historyColors.put(Integer.valueOf(5), new HistoryColor(resources.getColor(R.color.bc_history_operator_text), "bc_history_operator_text"));
            historyColors.put(Integer.valueOf(6), new HistoryColor(resources.getColor(R.color.bc_history_operator_background), "bc_history_operator_background"));
            historyColors.put(Integer.valueOf(7), new HistoryColor(resources.getColor(R.color.bc_history_operator_time), "bc_history_operator_time"));
            historyColors.put(Integer.valueOf(8), new HistoryColor(resources.getColor(R.color.bc_history_operator_sender), "bc_history_operator_sender"));
            historyColors.put(Integer.valueOf(9), new HistoryColor(resources.getColor(R.color.bc_history_system_text), "bc_history_system_text"));
            historyColors.put(Integer.valueOf(10), new HistoryColor(resources.getColor(R.color.bc_history_system_background), "bc_history_system_background"));
            int j = i;
...
/*
    static boolean access$202(BoldChatWebHistory boldchatwebhistory, boolean flag)
    {
        boldchatwebhistory.mIsLoaded = flag;
        return flag;
    }
