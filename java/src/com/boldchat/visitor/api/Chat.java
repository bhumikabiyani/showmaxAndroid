...
//            EndedReason, Account, ActiveAssistSession, Message, 
//            PersonType, ChatMessageListener, ChatStartListener, Form, 
//            FormField, ActiveAssistListener, ChatListener, ChatQueueListener, 
//            ChatTyperListener, LanguageChangeListener, ChatFinishedListener, ChatUnavailableListener, 
//            ChatRecaptureListener, PostChatSubmitListener, Typer, UnavailableReason, 
...
_L5:
    ...
    public void acceptActiveAssist(ActiveAssistSession activeassistsession)
    {
        ...
        hashmap.put("ActiveAssistID", activeassistsession.getActiveAssistID());
        callMethod("acceptActiveAssist", hashmap, null);
    }

    public void addActiveAssistListener(ActiveAssistListener activeassistlistener)
    {
        synchronized (activeAssistListeners)
        {
            activeAssistListeners.put(activeassistlistener, null);
        }
        return;
        activeassistlistener;
        weakhashmap;
        JVM INSTR monitorexit ;
        throw activeassistlistener;
    }
    ...
    public void cancelActiveAssist(ActiveAssistSession activeassistsession)
    {
        HashMap hashmap = getParamBase();
        hashmap.put("ActiveAssistID", activeassistsession.getActiveAssistID());
        callMethod("cancelActiveAssist", hashmap, null);
    }
    ...
    public void emailChatHistory(String s)
    {
        HashMap hashmap = getParamBase();
        hashmap.put("EmailAddress", s);
        callMethod("emailChatHistory", hashmap, null);
    }
    ...
    public void removeActiveAssistListener(ActiveAssistListener activeassistlistener)
    {
        synchronized (activeAssistListeners)
        {
            activeAssistListeners.remove(activeassistlistener);
        }
        return;
        activeassistlistener;
        weakhashmap;
