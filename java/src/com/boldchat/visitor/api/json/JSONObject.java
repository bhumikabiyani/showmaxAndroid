...
_L5:
        ...
        throws JSONException
    {
        ...
        if (obj instanceof JSONString)
        {
            ...
            {
                throw new JSONException((new StringBuilder()).append("Bad value from toJSONString: ").append(obj).toString());
            }
        }
...
_L3:
        ...
        throws JSONException
    {
        ...
        {
            throw new JSONException((new StringBuilder()).append("Unable to increment [").append(quote(s)).append("].").toString());
        }
    }
