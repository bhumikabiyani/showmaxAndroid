...
public final class MonitorableHttpsURLConnection extends HttpsURLConnection
{
    ...
    public void disconnect()
    {
        ...
        if (original != null && (original instanceof HttpURLConnection))
        {
    ...
    public String getCipherSuite()
    {
        ...
        {
            return ((HttpsURLConnection)original).getCipherSuite();
        } else
        {
            return "";
        }
        ...
        throws IOException
    {
        ...
        {
            NetLogManager.getInstance().cancelNetworkCall(registry, url.toExternalForm(), System.currentTimeMillis(), "HTTPS", aclass.getMessage());
            throw aclass;
        }
        return aclass;
    }
    ...
    public InputStream getErrorStream()
    {
        if (original instanceof HttpsURLConnection)
        {
            return ((HttpsURLConnection)original).getErrorStream();
        } else
        {
            return null;
        }
    ...
    public boolean getInstanceFollowRedirects()
    {
        if (original instanceof HttpsURLConnection)
        {
            return ((HttpsURLConnection)original).getInstanceFollowRedirects();
        } else
        {
            return true;
        }
    ...
    public Certificate[] getLocalCertificates()
    {
        if (original instanceof HttpsURLConnection)
        {
            return ((HttpsURLConnection)original).getLocalCertificates();
        } else
        {
            return null;
        }
    ...
    public String getRequestMethod()
    {
        if (original instanceof HttpsURLConnection)
        {
            return ((HttpsURLConnection)original).getRequestMethod();
        } else
        {
            return "GET";
        }
        ...
        throws IOException
    {
        if (original instanceof HttpsURLConnection)
        {
            return ((HttpsURLConnection)original).getResponseCode();
        } else
        {
            return -1;
        }
        ...
        throws IOException
    {
        if (original instanceof HttpsURLConnection)
        {
            return ((HttpsURLConnection)original).getResponseMessage();
        } else
        {
            return "";
        }
        ...
        throws SSLPeerUnverifiedException
    {
        if (original instanceof HttpsURLConnection)
        {
            return ((HttpsURLConnection)original).getServerCertificates();
        } else
        {
            return null;
        }
    ...
    public boolean usingProxy()
    {
        if (original instanceof HttpsURLConnection)
        {
            return ((HttpsURLConnection)original).usingProxy();
        } else
        {
            return false;
        }
