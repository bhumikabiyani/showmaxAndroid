...
label0:
    ...
    public void cancelNetworkCall(MonitorRegistry monitorregistry, String s, long l, String s1, String s2)
    {
        ...
        ActionNetwork.logNetwork(((StartConnectionInfo) (s)).url, ((StartConnectionInfo) (s)).startTime.longValue(), l, s1, 0, 0L, 0L, s2);
        this;
        JVM INSTR monitorexit ;
        return;
        monitorregistry;
...
_L4:
        l1 = ((Long)s.getValue()).longValue();
          goto _L3
        ActionNetwork.logNetwork(startconnectioninfo.url, startconnectioninfo.startTime.longValue(), l, startconnectioninfo.protocol, i, monitorregistry.longValue(), l1, null);
        this;
        JVM INSTR monitorexit ;
        return;
        monitorregistry;
    ...
    public void logNetworkRequest(String s, String s1, long l, long l1, int i, 
            long l2, long l3, String s2)
    {
        this;
        JVM INSTR monitorenter ;
        if (!checkIfURLisExcluded(s))
        {
            ActionNetwork.logNetwork(s, l, l1, s1, i, l2, l3, s2);
        }
        this;
        JVM INSTR monitorexit ;
        return;
