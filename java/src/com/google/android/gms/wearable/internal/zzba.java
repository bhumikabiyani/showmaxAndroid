    ...
    implements android.os.Parcelable.Creator
{
    ...
    {
        i = zzb.zzK(parcel);
        zzb.zzc(parcel, 1, zzaz1.versionCode);
        zzb.zzc(parcel, 2, zzaz1.statusCode);
        zzb.zza(parcel, 3, zzaz1.zzaGC);
        zzb.zzc(parcel, 4, zzaz1.zzaGE, false);
        zzb.zzH(parcel, i);
    }
    ...
    public zzaz zzfL(Parcel parcel)
    {
        ...
        do
        {
            if (parcel.dataPosition() < k)
            {
                ...
                case 4: // '\004'
                    arraylist = com.google.android.gms.common.internal.safeparcel.zza.zzc(parcel, l, zzaq.CREATOR);
                    break;
                }
            } else
            if (parcel.dataPosition() != k)
