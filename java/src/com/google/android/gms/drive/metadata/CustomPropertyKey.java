    ...
    implements SafeParcelable
{
    ...
    CustomPropertyKey(int i, String s, int j)
    {
        ...
        super();
        zzx.zzb(s, "key");
        zzx.zzb(zzVk.matcher(s).matches(), "key name characters must be alphanumeric or one of .!@$%^&*()-_/");
        boolean flag = flag1;
        if (j != 0)
        {
            if (j == 1)
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj != null)
        {
            ...
            if (obj instanceof CustomPropertyKey)
            {
                ...
                if (!((CustomPropertyKey) (obj)).getKey().equals(zzqd) || ((CustomPropertyKey) (obj)).getVisibility() != mVisibility)
                {
                    flag = false;
                }
                return flag;
    ...
    public int hashCode()
    {
        return (new StringBuilder()).append(zzqd).append(mVisibility).toString().hashCode();
    }
    ...
    {
        return (new StringBuilder()).append("CustomPropertyKey(").append(zzqd).append(",").append(mVisibility).append(")").toString();
    }
