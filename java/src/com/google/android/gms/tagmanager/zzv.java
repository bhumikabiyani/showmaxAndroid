...
_L1:
    ...
    private static class zzb
    {
        ...
        {
            return (new StringBuilder()).append("KeyAndSerialized: key = ").append(zzqd).append(" serialized hash = ").append(Arrays.hashCode(zzayw)).toString();
        }
    ...
    private void zzG(long l)
    {
        ...
        try
        {
            ...
            zzbf.zzab((new StringBuilder()).append("Deleted ").append(i).append(" expired items").toString());
            return;
        }
    ...
    private void zzcX(String s)
    {
        ...
        zzbf.zzab((new StringBuilder()).append("Cleared ").append(i).append(" items").toString());
        zztb();
        return;
        SQLiteException sqliteexception;
        sqliteexception;
        zzbf.zzac((new StringBuilder()).append("Error deleting entries with key prefix: ").append(s).append(" (").append(sqliteexception).append(").").toString());
        zztb();
        return;
        s;
        zztb();
    ...
    private void zzg(String as[])
    {
        ...
        if (as != null && as.length != 0)
        {
            if ((sqlitedatabase = zzar("Error opening database for deleteEntries.")) != null)
            {
                ...
                {
                    zzbf.zzac((new StringBuilder()).append("Error deleting entries ").append(Arrays.toString(as)).toString());
                }
                return;
            }
        }
    ...
    private void zzhd(int i)
    {
        ...
        {
            List list = zzhe(i);
            zzbf.zzaa((new StringBuilder()).append("DataLayer store full, deleting ").append(list.size()).append(" entries to make room.").toString());
...
_L6:
        obj = obj1;
        zzbf.zzac((new StringBuilder()).append("Error in peekEntries fetching entryIds: ").append(sqliteexception.getMessage()).toString());
        if (obj1 != null)
        {
            ((Cursor) (obj1)).close();
        }
