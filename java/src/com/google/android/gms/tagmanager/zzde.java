...
public class zzde
{
    ...
    public static com.google.android.gms.internal.zzd.zza zzdo(String s)
    {
        com.google.android.gms.internal.zzd.zza zza = new com.google.android.gms.internal.zzd.zza();
        zza.type = 5;
        zza.zzgA = s;
        return zza;
    }
    ...
    private static zzdd zzdp(String s)
    {
        ...
        {
            zzbf.zzZ((new StringBuilder()).append("Failed to convert '").append(s).append("' to a number.").toString());
            return zzaBo;
        }
        return zzdd1;
    }
    ...
    private static Double zzdr(String s)
    {
        s = zzdp(s);
        if (s == zzaBo)
        {
    ...
    public static Double zzj(com.google.android.gms.internal.zzd.zza zza)
    {
        return zzv(zzl(zza));
    }
    ...
    public static Object zzl(com.google.android.gms.internal.zzd.zza zza)
    {
        ...
        {
        default:
            zzbf.zzZ((new StringBuilder()).append("Failed to convert a value of type: ").append(zza.type).toString());
            return zzaBl;
        ...
        case 3: // '\003'
            ...
            {
                zzbf.zzZ((new StringBuilder()).append("Converting an invalid value to object: ").append(zza.toString()).toString());
                return zzaBl;
            }
