...
class zzao extends zzaj
{
    ...
    public com.google.android.gms.internal.zzd.zza zzH(Map map)
    {
        ...
        {
            zzbf.zzZ((new StringBuilder()).append("Hash: unknown input format: ").append(map).toString());
            return zzde.zzuf();
        }
        try
        {
        ...
        {
            zzbf.zzZ((new StringBuilder()).append("Hash: unknown algorithm: ").append(((String) (obj))).toString());
            return zzde.zzuf();
        }
        return map;
    }
