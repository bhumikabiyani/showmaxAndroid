...
class zzac extends zzaj
{
    ...
    public com.google.android.gms.internal.zzd.zza zzH(Map map)
    {
        ...
        String s1 = zzde.zzg(((com.google.android.gms.internal.zzd.zza) (obj)));
        ...
        if (map != null && zzde.zzk(map).booleanValue())
        {
            byte0 = 3;
        } else
        {
...
_L2:
        ...
        } else
        {
            try
            {
                zzbf.zzZ((new StringBuilder()).append("Encode: unknown input format: ").append(s).toString());
                map = zzde.zzuf();
            }
...
_L5:
        zzbf.zzZ((new StringBuilder()).append("Encode: unknown output format: ").append(((String) (obj))).toString());
        return zzde.zzuf();
