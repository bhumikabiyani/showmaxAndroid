...
public class DataLayer
{
    static final class zza
    {
        ...
        {
            return (new StringBuilder()).append("Key: ").append(zzqd).append(" value: ").append(zzzt.toString()).toString();
        }
...
label0:
    ...
    static Long zzcV(String s)
    {
        ...
        {
            zzbf.zzaa((new StringBuilder()).append("unknown _lifetime: ").append(s).toString());
            return null;
        }
        long l;
        try
        ...
        {
            zzbf.zzac((new StringBuilder()).append("illegal number in _lifetime value: ").append(s).toString());
            l = 0L;
        }
        if (l <= 0L)
        {
            zzbf.zzaa((new StringBuilder()).append("non-positive _lifetime: ").append(s).toString());
            return null;
        }
        ...
        {
        default:
            zzbf.zzac((new StringBuilder()).append("unknown units in _lifetime: ").append(s).toString());
            return null;
