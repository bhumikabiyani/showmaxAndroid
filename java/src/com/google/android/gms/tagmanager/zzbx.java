    ...
    implements zzat
{
        ...
        implements zzcw.zza
    {
        ...
        {
            zzbx.zza(zzazt, zzap1.zzgs());
            zzbf.zzab((new StringBuilder()).append("Permanent failure dispatching hitId: ").append(zzap1.zzgs()).toString());
        }
        ...
        public void zzc(zzap zzap1)
        {
            ...
            {
                zzbx.zza(zzazt, zzap1.zzgs());
                zzbf.zzab((new StringBuilder()).append("Giving up on failed hitId: ").append(zzap1.zzgs()).toString());
                return;
            }
        }
...
_L1:
        ...
        private boolean zza(String s, SQLiteDatabase sqlitedatabase)
        {
            ...
            sqlitedatabase = null;
_L4:
            zzbf.zzac((new StringBuilder()).append("Error querying for table ").append(s).toString());
            if (sqlitedatabase != null)
            {
                sqlitedatabase.close();
            }
...
_L1:
    ...
    private void zzd(long l, long l1)
    {
        ...
        {
            zzbf.zzac((new StringBuilder()).append("Error setting HIT_FIRST_DISPATCH_TIME for hitId: ").append(l).toString());
        }
        zzH(l);
    }
    ...
    private void zzgy()
    {
        ...
        {
            List list = zzM(i);
            zzbf.zzab((new StringBuilder()).append("Store full, deleting ").append(list.size()).append(" hits to make room.").toString());
...
_L6:
        obj = obj1;
        zzbf.zzac((new StringBuilder()).append("Error in peekHits fetching hitIds: ").append(sqliteexception.getMessage()).toString());
        if (obj1 != null)
        {
            ((Cursor) (obj1)).close();
        }
...
_L4:
        ...
        obj1 = obj3;
_L17:
        zzbf.zzac((new StringBuilder()).append("Error in peekHits fetching hitIds: ").append(((SQLiteException) (obj2)).getMessage()).toString());
        obj2 = obj;
...
_L15:
        obj1 = obj;
        zzbf.zzac((new StringBuilder()).append("Error in peekHits fetching hit url: ").append(((SQLiteException) (obj2)).getMessage()).toString());
        obj1 = obj;
        obj2 = new ArrayList();
        i = 0;
        obj1 = obj;
...
_L11:
        ...
        obj1 = obj;
        flag1 = TextUtils.isEmpty(((zzap) (obj4)).zztk());
        int j;
        j = i;
        if (!flag1)
        {
