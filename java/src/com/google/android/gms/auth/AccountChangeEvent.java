...
_L1:
        return (new StringBuilder()).append("AccountChangeEvent {accountName = ").append(zzHg).append(", changeType = ").append(s).append(", changeData = ").append(zzHj).append(", eventIndex = ").append(zzHi).append("}").toString();
_L2:
        s = "ADDED";
