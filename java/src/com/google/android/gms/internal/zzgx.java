...
public final class zzgx
{
    ...
    public static zzgq zza(Context context, zzgo zzgo1, String s)
    {
        ...
        {
            zzhx.zzac((new StringBuilder()).append("Could not parse the mediation config: ").append(context.getMessage()).toString());
            return new zzgq(0);
        }
        l1 = -1L;
...
_L2:
        ...
        {
            zzhx.zzac((new StringBuilder()).append("Problem serializing ad request to JSON: ").append(zzgo1.getMessage()).toString());
            return null;
        }
          goto _L4
        j = zzba1.height;
...
_L9:
        ...
        if (zzhx.zzA(2))
        {
            ...
            zzhx.zzab((new StringBuilder()).append("Ad Request JSON: ").append(zzgo1).toString());
        }
