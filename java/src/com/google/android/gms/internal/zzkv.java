...
public class zzkv
{
    ...
    private int size;
    private final LinkedHashMap zzQA;
    private int zzQB;
    private int zzQC;
    private int zzQD;
    private int zzQE;
...
_L1:
    ...
    public final String toString()
    {
        ...
        String s = String.format("LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", new Object[] {
            Integer.valueOf(zzQB), Integer.valueOf(zzQF), Integer.valueOf(zzQG), Integer.valueOf(i)
        });
        this;
        JVM INSTR monitorexit ;
        return s;
...
_L2:
        ...
        Object obj;
        Object obj1;
        obj1 = (java.util.Map.Entry)zzQA.entrySet().iterator().next();
