...
label0:
            ...
            if (s2.contains("%40mediation_adapters%40"))
            {
                ...
                zzha1.setUrl(zzic1);
                zzhx.zzab((new StringBuilder()).append("Ad request URL modified to ").append(zzic1).toString());
            }
...
label0:
            ...
            throw map;
            map = new zzha(1, map);
            zzhx.zzac((new StringBuilder()).append("Invalid ").append(map.getType()).append(" request error: ").append(map.zzdU()).toString());
