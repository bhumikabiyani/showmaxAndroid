    ...
    implements MediationBannerListener, MediationInterstitialListener
{
    ...
    public void onAdFailedToLoad(MediationBannerAdapter mediationbanneradapter, int i)
    {
        ...
        zzhx.zzY((new StringBuilder()).append("Adapter called onAdFailedToLoad with error. ").append(i).toString());
        try
        {
    ...
    {
        zzx.zzbd("onAdFailedToLoad must be called on the main UI thread.");
        zzhx.zzY((new StringBuilder()).append("Adapter called onAdFailedToLoad with error ").append(i).append(".").toString());
        try
        {
            zzsS.onAdFailedToLoad(i);
            return;
