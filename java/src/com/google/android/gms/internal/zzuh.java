...
public final class zzuh extends zzd
    implements Person
{
    ...
    {
        return new zztw.zzc(getString("image"));
    }
    ...
    {
        return zztw.zze.zzcF(getString("objectType"));
    }
    ...
    public ArrayList zzsq()
    {
        return null;
    }

    public ArrayList zzsr()
    {
        return null;
    }

    public ArrayList zzss()
    {
        return null;
    }
    ...
    public Person zzst()
    {
        return new zztw(getDisplayName(), getId(), (zztw.zzc)getImage(), getObjectType(), getUrl());
    }
}
