...
public abstract class zzvt
{
    ...
    {
        zzbf.zzZ((new StringBuilder()).append("ResourceManager: Failed to download a resource: ").append(zza1.name()).toString());
    ...
    public void zzo(byte abyte0[])
    {
        ...
        long l;
        long l1;
        zzbf.zzab((new StringBuilder()).append("ResourceManager: Resource downloaded from Network: ").append(zzaCG.getId()).toString());
