...
public class zzfj
{
    ...
    public int zzd(Intent intent)
    {
        ...
        {
            zzhx.zzac((new StringBuilder()).append("Unexpected type for intent response code. ").append(intent.getClass().getName()).toString());
            return 5;
        }
    }
    ...
    public int zzf(Bundle bundle)
    {
        ...
        {
            zzhx.zzac((new StringBuilder()).append("Unexpected type for intent response code. ").append(bundle.getClass().getName()).toString());
            return 5;
        }
    }
