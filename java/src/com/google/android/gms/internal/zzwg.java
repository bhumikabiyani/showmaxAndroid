    ...
    extends IInterface
{
        ...
        implements zzwg
    {
        ...
        public static zzwg zzcM(IBinder ibinder)
        {
            ...
            if (iinterface != null && (iinterface instanceof zzwg))
            {
                return (zzwg)iinterface;
            } else
            {
...
_L1:
    ...
    public abstract void zza(Status status, zzvz zzvz, Bundle bundle)
        throws RemoteException;

    public abstract void zzb(int i, boolean flag, Bundle bundle)
        throws RemoteException;

    public abstract void zzk(int i, Bundle bundle)
        throws RemoteException;
}
