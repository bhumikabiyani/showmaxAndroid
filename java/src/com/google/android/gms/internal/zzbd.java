...
public final class zzbd
{
    ...
    public zzbd(Context context, AttributeSet attributeset)
    {
        ...
        zzpf = context.getString(com.google.android.gms.R.styleable.AdsAttrs_adUnitId);
    ...
    private static AdSize[] zzq(String s)
    {
        String as[];
        AdSize aadsize[];
        int i;
