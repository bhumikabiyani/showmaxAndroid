...
public class zzvo
{
    ...
    private String zzdv(String s)
    {
        ...
        {
            zzbf.zzZ((new StringBuilder()).append("Cannot encode the string: ").append(s).toString());
            return "";
        }
        return s1;
    }
    ...
    {
        zzaya = s;
        zzbf.zzaa((new StringBuilder()).append("The Ctfe server endpoint was changed to: ").append(s).toString());
    }
    ...
    String zzw(List list)
    {
        ...
        stringbuilder.append("=").append(zzdv(zzve1.getContainerId())).append("&").append("pv").append("=").append(zzdv(list));
        if (zzve1.zzuk())
        {
