...
public class zzmk
{
    ...
    public static final zza zzWe = new zza("created", 0x3e8fa0);
    public static final zzb zzWf = new zzb("lastOpenedTime", 0x419ce0);
    public static final zzd zzWg = new zzd("modified", 0x3e8fa0);
    public static final zzc zzWh = new zzc("modifiedByMe", 0x3e8fa0);
    public static final zze zzWi = new zze("sharedWithMe", 0x3e8fa0);
