    ...
    extends IInterface
{
        ...
        implements zzdr
    {
            ...
            throws RemoteException
        {
            ...
            s = zzds.zza.zzs(parcel1.readStrongBinder());
            parcel1.recycle();
            parcel.recycle();
            return s;
            s;
    ...
    public abstract zzds zzB(String s)
        throws RemoteException;

    public abstract boolean zzC(String s)
        throws RemoteException;
}
