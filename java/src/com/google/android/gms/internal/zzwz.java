...
_L1:
        return;
_L2:
        if (!(obj instanceof zzwy)) goto _L4; else goto _L3
_L3:
        Class class1;
        Object aobj[];
        int i;
        ...
        if (s != null)
        {
            stringbuffer1.append(stringbuffer).append(zzdN(s)).append(" <\n");
            stringbuffer.append("  ");
        }
        class1 = obj.getClass();
...
_L4:
    ...
    private static String zzbt(String s)
    {
        int j = s.length();
    ...
    private static String zzdN(String s)
    {
    ...
    private static String zzdO(String s)
    {
        String s1 = s;
    ...
    public static String zzg(zzwy zzwy1)
    {
        if (zzwy1 == null)
        {
            return "";
        ...
        try
        {
            zza(null, zzwy1, new StringBuffer(), stringbuffer);
        }
        // Misplaced declaration of an exception variable
        catch (zzwy zzwy1)
        {
            return (new StringBuilder()).append("Error printing proto: ").append(zzwy1.getMessage()).toString();
        }
        // Misplaced declaration of an exception variable
        catch (zzwy zzwy1)
        {
