    ...
    implements Runnable
{
    ...
    void zzdo()
    {
        ...
        Object obj;
        obj;
        zzbf.zzZ((new StringBuilder()).append("NetworkLoader: No data is retrieved from the given url: ").append(s).toString());
        zzaCN.zza(zzvt.zza.zzaCK);
        zzvr1.close();
        return;
        obj;
        zzbf.zzb((new StringBuilder()).append("NetworkLoader: Error when loading resource from url: ").append(s).append(" ").append(((IOException) (obj)).getMessage()).toString(), ((Throwable) (obj)));
        zzaCN.zza(zzvt.zza.zzaCJ);
        zzvr1.close();
        return;
        obj;
        zzbf.zzb((new StringBuilder()).append("NetworkLoader: Error when parsing downloaded resources from url: ").append(s).append(" ").append(((IOException) (obj)).getMessage()).toString(), ((Throwable) (obj)));
        zzaCN.zza(zzvt.zza.zzaCK);
        zzvr1.close();
        return;
        Exception exception;
