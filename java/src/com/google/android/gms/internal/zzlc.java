    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(zzla.zza zza1, Parcel parcel, int i)
    {
        i = zzb.zzK(parcel);
        zzb.zzc(parcel, 1, zza1.versionCode);
        zzb.zza(parcel, 2, zza1.zzQN, false);
        zzb.zzc(parcel, 3, zza1.zzQO);
        zzb.zzH(parcel, i);
    }
    ...
    public zzla.zza zzO(Parcel parcel)
    {
        int j = 0;
