    ...
    implements SafeParcelable
{
    ...
    private zzpg(String s, LocationRequest locationrequest)
    {
        this(1, locationrequest, false, true, true, zzang, s);
    }

    public static zzpg zza(String s, LocationRequest locationrequest)
    {
        return new zzpg(s, locationrequest);
    }
