...
_L1:
    ...
    public static zzsm zzco(IBinder ibinder)
    {
        ...
        android.os.IInterface iinterface = ibinder.queryLocalInterface("com.google.android.gms.nearby.sharing.internal.INearbySharingCallback");
        if (iinterface != null && (iinterface instanceof zzsm))
        {
            return (zzsm)iinterface;
        } else
        {
