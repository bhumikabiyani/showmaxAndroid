    ...
    implements android.view.ViewTreeObserver.OnGlobalLayoutListener, android.view.ViewTreeObserver.OnScrollChangedListener
{
    ...
    private final zzcv zznF = new zzcv() {
        ...
        public void zza(zzic zzic, Map map)
        {
            ...
            {
                zzhx.zzY((new StringBuilder()).append("Received request to untrack: ").append(zzaf.zzb(zznI).zzaZ()).toString());
                zznI.destroy();
                return;
            }
        }
    ...
    public zzaf(zzba zzba1, zzhe zzhe1, zzhy zzhy, View view, zzdf zzdf1)
    {
        ...
        zzhx.zzY((new StringBuilder()).append("Tracking ad unit: ").append(zznq.zzaZ()).toString());
    }
    ...
    protected boolean zza(Map map)
    {
        ...
        boolean flag;
        if (!TextUtils.isEmpty(map) && map.equals(zznq.zzaZ()))
        {
            flag = true;
        } else
        {
...
_L1:
        ...
        zza(zzbj());
_L3:
        zzhx.zzY((new StringBuilder()).append("Untracking ad unit: ").append(zznq.zzaZ()).toString());
_L2:
        return;
        Object obj1;
        obj1;
