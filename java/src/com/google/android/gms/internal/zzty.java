    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(zztw.zza zza1, Parcel parcel, int i)
    {
        i = zzb.zzK(parcel);
        Set set = zza1.zzauX;
        ...
        {
            zzb.zzc(parcel, 2, zza1.zzawo);
        }
        if (set.contains(Integer.valueOf(3)))
        {
            zzb.zzc(parcel, 3, zza1.zzawp);
        }
        zzb.zzH(parcel, i);
    }
    ...
    public zztw.zza zzeC(Parcel parcel)
    {
        int k = 0;
        ...
        do
        {
            ...
            } else
            {
                ...
                return new zztw.zza(hashset, i, j, k);
            }
        } while (true);
    }

    public zztw.zza[] zzgP(int i)
    {
