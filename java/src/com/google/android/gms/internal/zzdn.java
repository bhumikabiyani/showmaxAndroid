    ...
    implements zzdo.zza
{
    ...
    private zzds zzcL()
    {
        zzhx.zzaa((new StringBuilder()).append("Instantiating mediation adapter: ").append(zzsC).toString());
        zzds zzds1;
        try
        {
            zzds1 = zzlD.zzB(zzsC);
        ...
        {
            zzhx.zza((new StringBuilder()).append("Could not instantiate mediation adapter: ").append(zzsC).toString(), remoteexception);
            return null;
        }
        return zzds1;
    }
...
_L1:
    ...
    public zzdo zzb(long l, long l1)
    {
        Object obj1;
        synchronized (zznh)
        {
