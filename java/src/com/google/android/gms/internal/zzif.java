...
_L1:
    ...
    public void onDownloadStart(String s, String s1, String s2, String s3, long l)
    {
        ...
        {
            zzhx.zzY((new StringBuilder()).append("Couldn't find an Activity to view url/mimetype: ").append(s).append(" / ").append(s3).toString());
        }
    }
...
_L4:
        ...
        zzhx.zzac((new StringBuilder()).append("Not enough space to show ad. Needs ").append((int)((float)zzsF.widthPixels / f)).append("x").append((int)((float)zzsF.heightPixels / f)).append(" dp, but only has ").append((int)((float)k / f)).append("x").append((int)((float)i1 / f)).append(" dp.").toString());
        if (getVisibility() != 8)
        {
            setVisibility(4);
        }
...
_L1:
    ...
    protected void zzae(String s)
    {
        if (zzme.zzkj())
        {
            ...
            {
                zzad((new StringBuilder()).append("javascript:").append(s).toString());
                return;
            }
        } else
        {
    ...
    public void zzb(String s, JSONObject jsonobject)
    {
        ...
        ((StringBuilder) (obj)).append(");");
        zzhx.zzab((new StringBuilder()).append("Dispatching AFMA event: ").append(((StringBuilder) (obj)).toString()).toString());
