...
public class zzk
{
    ...
    public zzk(zzg zzg1)
    {
        zzkU = "googleads.g.doubleclick.net";
        zzkV = "/pagead/ads";
        zzkW = "ad.doubleclick.net";
        zzkY = zzg1;
    }
