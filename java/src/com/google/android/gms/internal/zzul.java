        ...
        implements zzul
    {
            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                zza(zzuk.zza.zzcB(parcel.readStrongBinder()), parcel.createByteArray());
                parcel1.writeNoException();
                return true;

            case 2: // '\002'
                parcel.enforceInterface("com.google.android.gms.safetynet.internal.ISafetyNetService");
                zza(zzuk.zza.zzcB(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
            }
        }
...
_L1:
    ...
    public abstract void zza(zzuk zzuk)
        throws RemoteException;

    public abstract void zza(zzuk zzuk, byte abyte0[])
        throws RemoteException;
}
