    ...
    implements zzvm
{
    ...
    public void zza(Status status, Object obj, Integer integer, long l)
    {
        ...
        {
            status = new a(new Status(16, (new StringBuilder()).append("There is no valid resource for the container: ").append(zzaBS.getContainerId()).toString()), null, a.zza.zzaCg);
        }
