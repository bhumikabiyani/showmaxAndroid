...
_L6:
    ...
    public static final class zzf extends zzws
    {
        ...
        public static zzf zza(byte abyte0[])
            throws zzwx
        {
            return (zzf)zzwy.zza(new zzf(), abyte0);
        }
        ...
        public boolean equals(Object obj)
        {
            ...
            } else
            {
                ...
                if (obj instanceof zzh)
                {
                    obj = (zzh)obj;
                    flag = flag1;
                    if (zzww.equals(zzgh, ((zzh) (obj)).zzgh))
                    {
                        flag = flag1;
                        if (zzww.equals(zzgi, ((zzh) (obj)).zzgi))
                        {
                            flag = flag1;
                            if (zzww.equals(zzgj, ((zzh) (obj)).zzgj))
                            {
                                flag = flag1;
                                if (zzgk == ((zzh) (obj)).zzgk)
                                {
                                    flag = flag1;
                                    if (zzww.equals(zzgl, ((zzh) (obj)).zzgl))
                                    {
                                        flag = flag1;
                                        if (zzgm == ((zzh) (obj)).zzgm)
                                        {
                                            flag = flag1;
                                            if (zzgn == ((zzh) (obj)).zzgn)
                                            {
                                                return zza(((zzws) (obj)));
                                            }
                                        }
