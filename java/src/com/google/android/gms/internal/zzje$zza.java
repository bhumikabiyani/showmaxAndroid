...
_L1:
        ...
        throws RemoteException
    {
        ...
        case 1: // '\001'
            ...
            zza(zzJ(parcel.readStrongBinder()), parcel.readString(), (zzjb[])parcel.createTypedArray(zzjb.CREATOR));
            parcel1.writeNoException();
            return true;

        case 2: // '\002'
            parcel.enforceInterface("com.google.android.gms.appdatasearch.internal.ILightweightAppDataSearch");
            zza(zzJ(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;

        case 3: // '\003'
            parcel.enforceInterface("com.google.android.gms.appdatasearch.internal.ILightweightAppDataSearch");
            zzb(zzJ(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;

        case 4: // '\004'
            parcel.enforceInterface("com.google.android.gms.appdatasearch.internal.ILightweightAppDataSearch");
            zzjf zzjf = zzJ(parcel.readStrongBinder());
            boolean flag;
            if (parcel.readInt() != 0)
            {
                flag = true;
        ...
        case 5: // '\005'
            ...
            if (parcel.readInt() != 0)
            {
                zza1 = CREATOR.zzp(parcel);
            } else
            {
                zza1 = null;
            }
            zza(zza1, zzJ(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;

        case 6: // '\006'
            parcel.enforceInterface("com.google.android.gms.appdatasearch.internal.ILightweightAppDataSearch");
            zza(zzJ(parcel.readStrongBinder()), parcel.readString(), parcel.readString());
            parcel1.writeNoException();
            return true;
        }
    }
