...
_L3:
    ...
    {
        zzhx.zzac((new StringBuilder()).append("Failed to load ad: ").append(i).toString());
        if (zzlE.zzlT == null)
        {
    ...
    Bundle zza(zzan zzan1)
    {
        if (zzan1 != null)
        {
            ...
            {
                zzan1 = zzak1.zzbm();
                zzhx.zzY((new StringBuilder()).append("In AdManger: loadAd, ").append(zzak1.toString()).toString());
            } else
            {
                zzan1 = null;
            }
    ...
    public void zza(zzhe.zza zza1)
    {
        ...
        zzhx.zzY((new StringBuilder()).append("AdRenderer: ").append(zzlE.zzlU.getClass().getName()).toString());
    }
    ...
    public boolean zza(zzax zzax1)
    {
        ...
        } else
        {
            ...
            if (zzav())
            {
                ...
                if (!zzax1.zzoO)
                {
                    zzhx.zzaa((new StringBuilder()).append("Use AdRequest.Builder.addTestDevice(\"").append(zzbe.zzbD().zzz(zzlE.zzlN)).append("\") to get test ads on this device.").toString());
                }
    ...
    public void zzal()
    {
        if (zzlE.zzlW != null)
        {
            zzhx.zzac((new StringBuilder()).append("Mediation adapter ").append(zzlE.zzlW.zzsN).append(" refreshed, but mediation adapters should never refresh.").toString());
        }
        zze(true);
        zzas();
    }
    ...
    protected boolean zzao()
    {
        ...
        {
            if ((window = ((Activity)zzlE.zzlN).getWindow()) != null && window.getDecorView() != null)
            {
                Rect rect = new Rect();
                Rect rect1 = new Rect();
