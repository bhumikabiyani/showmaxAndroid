...
public static final class zzwn extends zzwy
{
...
_L2:
        ...
        if (zzfl == null)
        {
            if (((zzfl) (obj)).zzfl != null)
            {
                return false;
            }
        } else
        if (!zzfl.equals(((zzfl) (obj)).zzfl))
        {
            return false;
        }
        if (name == null)
        ...
        if (description == null)
        {
            if (((description) (obj)).description != null)
            {
                return false;
            }
        } else
        if (!description.equals(((description) (obj)).description))
        {
            return false;
        }
        if (zzaIL == null)
        ...
        if (zzaIM == null)
        {
            if (((zzaIM) (obj)).zzaIM != null)
            {
                return false;
            }
        } else
        if (!zzaIM.equals(((zzaIM) (obj)).zzaIM))
        {
            return false;
        }
        if (zzaIN == null)
        {
            if (((zzaIN) (obj)).zzaIN != null)
            {
                return false;
            }
        } else
        if (!zzaIN.equals(((zzaIN) (obj)).zzaIN))
        {
            return false;
        }
        if (zzaIe == null)
        ...
        if (((zzaIO) (obj)).zzaIO == null) goto _L1; else goto _L3
_L3:
        return false;
        if (zzaIO.equals(((zzaIO) (obj)).zzaIO)) goto _L1; else goto _L4
_L4:
        return false;
    }
