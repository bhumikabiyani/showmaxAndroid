...
class zzaBV extends zzvt
{
    ...
    protected void zza(zzvk zzvk1)
    {
        ...
        if (zzabv.getStatus().isSuccess())
        {
            zzbf.zzab((new StringBuilder()).append("Response source: ").append(zzabv.zzup().toString()).toString());
            zzbf.zzab((new StringBuilder()).append("Response size: ").append(zzabv.zzuq().length).toString());
        }
