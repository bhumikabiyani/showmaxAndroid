...
public class zzvg
{
    ...
    class zzb extends zzvt
    {
        ...
        protected void zza(zzvk zzvk1)
        {
            ...
            if (zza1.getStatus().isSuccess())
            {
                zzbf.zzab((new StringBuilder()).append("Response source: ").append(zza1.zzup().toString()).toString());
                zzbf.zzab((new StringBuilder()).append("Response size: ").append(zza1.zzuq().length).toString());
            }
    ...
    void zza(zzve zzve1, zza zza1)
    {
        zzaBP.zza(zzve1.zzuj(), zzve1.zzuh(), zzvi.zzaBX, new zzvm(zzve1, zza1) {
            ...
            public void zza(Status status, Object obj, Integer integer, long l)
            {
                ...
                {
                    status = new zzvk.zza(new Status(16, (new StringBuilder()).append("There is no valid resource for the container: ").append(zzaBS.getContainerId()).toString()), null, zzvk.zza.zza.zzaCg);
                }
