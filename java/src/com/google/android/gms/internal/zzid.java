...
public class zzid extends WebViewClient
{
    ...
    private void zzg(Uri uri)
    {
        ...
        if (obj != null)
        {
            ...
            if (zzhx.zzA(2))
            {
                zzhx.zzab((new StringBuilder()).append("Received GMSG: ").append(s).toString());
                String s1;
                for (Iterator iterator = uri.keySet().iterator(); iterator.hasNext(); zzhx.zzab((new StringBuilder()).append("  ").append(s1).append(": ").append((String)uri.get(s1)).toString()))
                {
        ...
        {
            zzhx.zzab((new StringBuilder()).append("No GMSG handler found for GMSG: ").append(uri).toString());
        }
    }

    public final void onLoadResource(WebView webview, String s)
    {
        zzhx.zzab((new StringBuilder()).append("Loading resource: ").append(s).toString());
        webview = Uri.parse(s);
    ...
    {
        Uri uri;
        zzhx.zzab((new StringBuilder()).append("AdWebView shouldOverrideUrlLoading: ").append(s).toString());
        uri = Uri.parse(s);
...
_L2:
        ...
        if (zzk1 != null)
        {
            ...
            {
                zzhx.zzac((new StringBuilder()).append("Unable to append parameter to URL: ").append(s).toString());
                webview = uri;
            }
        }
        ...
        zzhx.zzac((new StringBuilder()).append("AdWebView unable to handle URL: ").append(s).toString());
