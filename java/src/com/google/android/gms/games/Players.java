...
public interface Players
{
    ...
    public abstract Intent getCompareProfileIntent(GoogleApiClient googleapiclient, Player player);
    ...
    public abstract PendingResult loadPlayer(GoogleApiClient googleapiclient, String s, boolean flag);
