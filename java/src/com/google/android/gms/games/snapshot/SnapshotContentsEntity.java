    ...
    implements SafeParcelable, SnapshotContents
{
    ...
    private boolean zza(int i, byte abyte0[], int j, int k, boolean flag)
    {
        ...
        obj1 = new FileOutputStream(zzTO.getParcelFileDescriptor().getFileDescriptor());
        ...
        throws IOException
    {
        ...
        fileinputstream = new FileInputStream(zzTO.getParcelFileDescriptor().getFileDescriptor());
        bufferedinputstream = new BufferedInputStream(fileinputstream);
        byte abyte0[];
        fileinputstream.getChannel().position(0L);
        abyte0 = zzlz.zza(bufferedinputstream, false);
        fileinputstream.getChannel().position(0L);
        return abyte0;
        Object obj1;
        obj1;
