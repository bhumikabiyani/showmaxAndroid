    ...
    implements SafeParcelable, Snapshot
{
    ...
    {
        zzFG = i;
        zzakC = new SnapshotMetadataEntity(snapshotmetadata);
        zzakD = snapshotcontentsentity;
    }
...
_L5:
    ...
    {
        com.google.android.gms.common.internal.zzw.zza zza1 = zzw.zzk(snapshot).zza("Metadata", snapshot.getMetadata());
        boolean flag;
        ...
        return zza1.zza("HasContents", Boolean.valueOf(flag)).toString();
    }
