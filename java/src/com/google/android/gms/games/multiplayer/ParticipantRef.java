    ...
    implements Participant
{
    ...
    {
        super(dataholder, i);
        zzajF = new PlayerRef(dataholder, i);
    }
    ...
    public void getDisplayName(CharArrayBuffer chararraybuffer)
    {
        ...
        {
            zzajF.getDisplayName(chararraybuffer);
            return;
        }
    }
