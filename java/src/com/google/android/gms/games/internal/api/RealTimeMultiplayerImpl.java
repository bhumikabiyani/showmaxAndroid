    ...
    implements RealTimeMultiplayer
{
    ...
    private static zze zza(GoogleApiClient googleapiclient, Object obj)
    {
        if (obj == null)
        {
            return null;
        ...
        {
            return googleapiclient.zzf(obj);
        }
    }
    ...
    public void create(GoogleApiClient googleapiclient, RoomConfig roomconfig)
    {
        ...
        {
            gamesclientimpl.zza(googleapiclient.zzf(roomconfig.getRoomUpdateListener()), zza(googleapiclient, roomconfig.getRoomStatusUpdateListener()), zza(googleapiclient, roomconfig.getMessageReceivedListener()), roomconfig);
            return;
        }
    }
    ...
    public void join(GoogleApiClient googleapiclient, RoomConfig roomconfig)
    {
        ...
        {
            gamesclientimpl.zzb(googleapiclient.zzf(roomconfig.getRoomUpdateListener()), zza(googleapiclient, roomconfig.getRoomStatusUpdateListener()), zza(googleapiclient, roomconfig.getMessageReceivedListener()), roomconfig);
            return;
        }
    }
    ...
    public void leave(GoogleApiClient googleapiclient, RoomUpdateListener roomupdatelistener, String s)
    {
        ...
        if (gamesclientimpl != null)
        {
            gamesclientimpl.zza(googleapiclient.zzf(roomupdatelistener), s);
        }
    }
