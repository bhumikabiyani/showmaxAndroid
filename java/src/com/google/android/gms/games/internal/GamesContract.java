...
public final class GamesContract
{
    ...
    public static interface AppContentActionColumns
    {

        public static final String zzafp[] = {
            "action_id", "action_annotation", "action_conditions", "action_content_description", "action_data", "overflow_text", "action_type"
        };

    }

    public static interface AppContentAnnotationColumns
    {

        public static final String zzafp[] = {
            "annotation_id", "annotation_description", "annotation_image_default_id", "annotation_image_height", "annotation_image_uri", "annotation_image_width", "annotation_layout_slot", "annotation_modifiers", "annotation_title"
        };

    }

    public static interface AppContentCardColumns
    {

        public static final String zzafp[] = {
            "card_actions", "card_annotations", "card_id", "card_conditions", "card_content_description", "card_current_steps", "card_data", "card_description", "card_subtitle", "card_title", 
            "card_total_steps", "card_type"
        };
    ...
    public static interface AppContentConditionColumns
    {

        public static final String zzafp[] = {
            "condition_id", "condition_default_value", "condition_expected_value", "condition_predicate", "condition_predicate_parameters"
        };

    }

    public static interface AppContentSectionColumns
    {

        public static final String zzafp[] = {
            "section_actions", "section_annotations", "section_card_type", "section_content_description", "section_data", "section_description", "section_id", "section_subtitle", "section_title", "section_type"
        };

    }

    public static interface AppContentTupleColumns
    {

        public static final String zzafp[] = {
            "tuple_name", "tuple_id", "tuple_value"
        };
    ...
    public static interface GamesColumns
    {
        ...
        public static final String zzafp[] = {
            ...
            "sync_token", "target_instance", "gameplay_acl_status", "achievement_total_count", "leaderboard_count", "muted", "identity_sharing_confirmed", "snapshots_enabled", "theme_color"
        };
    ...
    public static interface ProfileSettingsColumns
    {

        public static final String zzafp[] = {
            "profile_visible", "profile_visibility_explicitly_set"
        };
    ...
    public static interface SnapshotColumns
    {
        ...
        public static final String zzafp[] = {
            ...
            "title", "description", "last_modified_timestamp", "duration", "unique_name", "visible", "pending_change_count", "progress_value"
        };
