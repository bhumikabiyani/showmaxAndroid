...
_L1:
        zzae.zzac((new StringBuilder()).append("Request too long (> ").append(Math.min(zzBh, zzBi)).append(" bytes)--not sent").toString());
_L4:
        return true;
_L2:
...
_L8:
        ...
        {
            zzae.zzac((new StringBuilder()).append("Exception sending hit: ").append(s.getClass().getSimpleName()).toString());
...
_L9:
        ...
        {
            zzae.zzZ((new StringBuilder()).append("Unexpected IOException: ").append(s.getMessage()).toString());
            zzae.zzZ("Request will be discarded");
            return true;
        }
          goto _L9
        zzae.zzac((new StringBuilder()).append("Bad response: ").append(s.getStatusLine().getStatusCode()).toString());
        return true;
    }
...
_L6:
        ...
        l1 = l2;
          goto _L8
_L7:
        if (l1 <= (long)zzBi) goto _L10; else goto _L9
_L9:
...
_L11:
        ...
        j = 1;
_L19:
        if (j >= ((List) (obj2)).size()) goto _L10; else goto _L17
_L17:
