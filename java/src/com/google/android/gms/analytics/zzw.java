...
_L2:
        ...
        JVM INSTR tableswitch 1 7: default 366
    //                   1 108
    //                   2 220
    //                   3 366
    //                   4 366
...
_L4:
        ...
        {
            zzd1 = (zzd)zzCm.poll();
            zzae.zzab((new StringBuilder()).append("Sending hit to store  ").append(zzd1).toString());
        }
...
_L10:
        zzd zzd2;
        zzd2 = (zzd)zzCm.peek();
        zzae.zzab((new StringBuilder()).append("Sending hit to service   ").append(zzd2).toString());
...
_L1:
        zzae.zzac((new StringBuilder()).append("Service unavailable (code=").append(i).append("), will retry.").toString());
        zzfR();
_L4:
        this;
        JVM INSTR monitorexit ;
        return;
_L2:
        zzae.zzac((new StringBuilder()).append("Service unavailable (code=").append(i).append("), using local store.").toString());
        zzfP();
        if (true) goto _L4; else goto _L3
_L3:
        intent;
