    ...
    implements com.google.android.gms.analytics.zzb
{
        ...
        implements ServiceConnection
    {
        ...
        {
            zzae.zzab((new StringBuilder()).append("service connected, binder: ").append(ibinder).toString());
            try
            {
        ...
        {
            zzae.zzab((new StringBuilder()).append("service disconnected: ").append(componentname).toString());
            com.google.android.gms.analytics.zzc.zza(zzAX, null);
    ...
    public void connect()
    {
        ...
        } else
        {
            ...
            zzae.zzab((new StringBuilder()).append("connect: bindService returned ").append(flag).append(" for ").append(intent).toString());
            if (!flag)
            {
                zzAT = null;
                zzAV.zza(1, null);
    ...
    public void zza(Map map, long l, String s, List list)
    {
        ...
        {
            zzae.zzZ((new StringBuilder()).append("sendHit failed: ").append(map).toString());
        }
    }
    ...
    public void zzfa()
    {
        ...
        {
            zzae.zzZ((new StringBuilder()).append("clear hits failed: ").append(remoteexception).toString());
        }
    }
