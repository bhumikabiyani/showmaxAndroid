...
_L3:
    ...
    protected zzk(Context context, Looper looper, int i, com.google.android.gms.common.api.GoogleApiClient.ConnectionCallbacks connectioncallbacks, com.google.android.gms.common.api.GoogleApiClient.OnConnectionFailedListener onconnectionfailedlistener)
    {
        zznh = new Object();
        zzPJ = false;
        zzPM = new ArrayList();
    ...
    protected zzk(Context context, Looper looper, int i, com.google.android.gms.common.api.GoogleApiClient.ConnectionCallbacks connectioncallbacks, com.google.android.gms.common.api.GoogleApiClient.OnConnectionFailedListener onconnectionfailedlistener, com.google.android.gms.common.internal.zzf zzf1)
    {
...
label0:
    ...
    public void connect()
    {
        ...
        } else
        {
            if (zzPN != null)
            {
                Log.e("GmsClient", (new StringBuilder()).append("Calling connect() while still connected, missing disconnect() for ").append(zzcF()).toString());
                zzPH.zzb(zzcF(), zzPN, zziZ());
            }
            zzPN = new zze();
            if (!zzPH.zza(zzcF(), zzPN, zziZ()))
            {
                Log.e("GmsClient", (new StringBuilder()).append("unable to connect to service: ").append(zzcF()).toString());
...
_L5:
    ...
    public void zza(zzq zzq)
    {
        ...
        {
            Log.w("GmsClient", "Remote exception occurred", zzq);
        }
    }
