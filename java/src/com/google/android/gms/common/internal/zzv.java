...
public class zzv
{
    ...
    public static zzv zzbm(String s)
    {
        return new zzv(s);
    }
    ...
    public final StringBuilder zza(StringBuilder stringbuilder, Iterable iterable)
    {
        ...
        if (iterable.hasNext())
        {
            stringbuilder.append(zzj(iterable.next()));
            for (; iterable.hasNext(); stringbuilder.append(zzj(iterable.next())))
            {
