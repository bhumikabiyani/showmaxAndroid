...
_L2:
    ...
    private void zza(GoogleApiClient googleapiclient, com.google.android.gms.common.api.zzg zzg1, boolean flag)
    {
        zzko.zzQy.zzc(googleapiclient).setResultCallback(new ResultCallback(zzg1, flag, googleapiclient) {
    ...
    static void zza(com.google.android.gms.common.api.zzd zzd1, GoogleApiClient googleapiclient, com.google.android.gms.common.api.zzg zzg1, boolean flag)
    {
        zzd1.zza(googleapiclient, zzg1, flag);
    }
...
_L1:
        ...
        timeunit = ConnectionResult.zzLr;
        zzCN.unlock();
        return timeunit;
        if (zzMx == null)
        {
    ...
    public PendingResult clearDefaultAccountAndReconnect()
    {
        ...
        com.google.android.gms.common.api.zzg zzg1 = new com.google.android.gms.common.api.zzg(zzMc);
        if (zzMJ.containsKey(zzko.zzGR))
        {
            zza(this, zzg1, false);
            return zzg1;
        } else
        {
            ...
            Object obj = new GoogleApiClient.ConnectionCallbacks(atomicreference, zzg1) {

                final com.google.android.gms.common.api.zzd zzNb;
                final AtomicReference zzNc;
                final com.google.android.gms.common.api.zzg zzNd;

                public void onConnected(Bundle bundle)
                {
                    com.google.android.gms.common.api.zzd.zza(zzNb, (GoogleApiClient)zzNc.get(), zzNd, true);
                }
            ...
            {
                zzNb = com.google.android.gms.common.api.zzd.this;
                zzNc = atomicreference;
                zzNd = zzg1;
                super();
            }
            };
            GoogleApiClient.OnConnectionFailedListener onconnectionfailedlistener = new GoogleApiClient.OnConnectionFailedListener(zzg1) {
            ...
            obj = (new GoogleApiClient.Builder(mContext)).addApi(zzko.API).addConnectionCallbacks(((GoogleApiClient.ConnectionCallbacks) (obj))).addOnConnectionFailedListener(onconnectionfailedlistener).setHandler(zzMG).build();
...
_L6:
    ...
    {
        return zzMu.isConnectionCallbacksRegistered(connectioncallbacks);
    }

    public boolean isConnectionFailedListenerRegistered(GoogleApiClient.OnConnectionFailedListener onconnectionfailedlistener)
    {
        return zzMu.isConnectionFailedListenerRegistered(onconnectionfailedlistener);
    }
    ...
    public void stopAutoManage(FragmentActivity fragmentactivity)
    {
        ...
        zzx.zza(flag, "Called stopAutoManage but automatic lifecycle management is not enabled.");
        com.google.android.gms.common.api.zzh.zza(fragmentactivity).zzas(zzMv);
    }
...
_L3:
    ...
    {
        return zzMJ.containsKey(api.zzhV());
    }

    public boolean zza(Scope scope)
    {
        return zzMM.contains(scope.zzio());
    }
    ...
    public com.google.android.gms.common.api.zze zzf(Object obj)
    {
        zzx.zzb(obj, "Listener must not be null");
        zzCN.lock();
        obj = new com.google.android.gms.common.api.zze(zzMc, obj);
        zzMV.add(obj);
        zzCN.unlock();
        return ((com.google.android.gms.common.api.zze) (obj));
        obj;
        zzCN.unlock();
        throw obj;
    }
