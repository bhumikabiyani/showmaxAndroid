...
//            IStreetViewPanoramaDelegate, zzu
        ...
        implements IStreetViewPanoramaFragmentDelegate
    {
            ...
            throws RemoteException
        {
            ...
            case 2: // '\002'
                ...
                if (parcel.readInt() != 0)
                {
                    streetviewpanoramaoptions = StreetViewPanoramaOptions.CREATOR.zzdQ(parcel);
                } else
                {
            ...
            case 12: // '\f'
                parcel.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                getStreetViewPanoramaAsync(zzu.zza.zzbP(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
            }
        }
...
_L1:
    ...
    public abstract void getStreetViewPanoramaAsync(zzu zzu)
        throws RemoteException;
