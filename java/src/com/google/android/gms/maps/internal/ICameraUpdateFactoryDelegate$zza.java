...
_L1:
            ...
            cameraposition = com.google.android.gms.dynamic.zzd.zza.zzau(parcel1.readStrongBinder());
            parcel1.recycle();
            parcel.recycle();
...
_L1:
            ...
            parcel1.readException();
            latlngbounds = com.google.android.gms.dynamic.zzd.zza.zzau(parcel1.readStrongBinder());
            parcel1.recycle();
            parcel.recycle();
            return latlngbounds;
            parcel.writeInt(0);
...
_L1:
        ...
        throws RemoteException
    {
        ...
        case 7: // '\007'
            ...
            if (parcel.readInt() != 0)
            {
                parcel = CameraPosition.CREATOR.zzdS(parcel);
            } else
            {
                parcel = null;
            }
