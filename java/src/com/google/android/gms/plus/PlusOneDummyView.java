...
_L5:
    ...
    public PlusOneDummyView(Context context, int i)
    {
        ...
        context.setBackgroundDrawable(zzrJ().getDrawable(i));
        Point point = zzgJ(i);
...
_L5:
    ...
    private zzd zzrJ()
    {
        Object obj1 = new zzb(getContext());
        Object obj = obj1;
        if (!((zzd) (obj1)).isValid())
        {
            obj = new zzc(getContext());
        }
        obj1 = obj;
        if (!((zzd) (obj)).isValid())
        {
            obj1 = new zza(getContext());
        }
        return ((zzd) (obj1));
    }
}
