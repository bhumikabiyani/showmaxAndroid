    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(zzao zzao1, Parcel parcel, int i)
    {
        ...
        zzb.zza(parcel, 1, zzao1.zzmb(), i, false);
        zzb.zzc(parcel, 1000, zzao1.getVersionCode());
        zzb.zza(parcel, 2, zzao1.zzlQ(), false);
        zzb.zza(parcel, 3, zzao1.getPackageName(), false);
        zzb.zzH(parcel, j);
    }
...
_L3:
        ...
        {
            return new zzao(i, ((PendingIntent) (obj)), ((android.os.IBinder) (obj1)), s);
        }
    }
