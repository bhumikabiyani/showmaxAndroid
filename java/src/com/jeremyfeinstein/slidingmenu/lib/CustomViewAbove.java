...
public class CustomViewAbove extends ViewGroup
{
    ...
    private static final int TRANSFORM_FROM_DEGREES = 0;
    private static final int TRANSFORM_TO_DEGREES = 10;
    private static final int TRANSFORM_Z_DEPTH = 10;
    ...
    private Camera mTransformCamera;
...
_L5:
    ...
    {
        canvas.save();
        transformCanvas(canvas, getPercentOpen());
...
_L5:
    ...
    public void transformCanvas(Canvas canvas, float f)
    {
        ...
        mTransformCamera.translate(0.0F, 0.0F, 10F * f);
        mTransformCamera.rotateY(-(0.0F + 10F * f));
        mTransformCamera.getMatrix(matrix);
        mTransformCamera.restore();
        matrix.preTranslate(-f1, -f2);
        matrix.postTranslate(f1, f2);
        f = (float)((double)(1.0F - f) * 0.25D + 0.75D);
        canvas.scale(f, f, 0.0F, canvas.getHeight() / 2);
