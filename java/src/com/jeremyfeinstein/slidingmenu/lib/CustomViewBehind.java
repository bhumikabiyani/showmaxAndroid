...
_L3:
    ...
    {
        int i;
        while (!mSelectorEnabled || mSelectorDrawable == null || mSelectedView == null || !((String)mSelectedView.getTag(com.showmax.lib.slidingmenu.R.id.selected_view)).equals("CustomViewBehindSelectedView")) 
        {
            return;
        }
        canvas.save();
...
_L3:
    ...
    public void setSelectedView(View view)
    {
        ...
        {
            mSelectedView.setTag(com.showmax.lib.slidingmenu.R.id.selected_view, null);
            mSelectedView = null;
        }
        if (view != null && view.getParent() != null)
        {
            mSelectedView = view;
            mSelectedView.setTag(com.showmax.lib.slidingmenu.R.id.selected_view, "CustomViewBehindSelectedView");
            invalidate();
        }
    }
