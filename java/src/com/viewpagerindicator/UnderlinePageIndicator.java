    ...
    implements PageIndicator
{
    ...
    public UnderlinePageIndicator(Context context, AttributeSet attributeset, int i)
    {
        ...
        boolean flag = ((Resources) (obj)).getBoolean(R.bool.default_underline_indicator_fades);
        int j = ((Resources) (obj)).getInteger(R.integer.default_underline_indicator_fade_delay);
        int k = ((Resources) (obj)).getInteger(R.integer.default_underline_indicator_fade_length);
        int l = ((Resources) (obj)).getColor(R.color.default_underline_indicator_selected_color);
        attributeset = context.obtainStyledAttributes(attributeset, R.styleable.UnderlinePageIndicator, i, 0);
        setFades(attributeset.getBoolean(R.styleable.UnderlinePageIndicator_fades, flag));
        setSelectedColor(attributeset.getColor(R.styleable.UnderlinePageIndicator_selectedColor, l));
        setFadeDelay(attributeset.getInteger(R.styleable.UnderlinePageIndicator_fadeDelay, j));
        setFadeLength(attributeset.getInteger(R.styleable.UnderlinePageIndicator_fadeLength, k));
        obj = attributeset.getDrawable(R.styleable.UnderlinePageIndicator_android_background);
        if (obj != null)
        {
