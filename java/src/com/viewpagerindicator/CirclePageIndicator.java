    ...
    implements PageIndicator
{
    ...
    public CirclePageIndicator(Context context, AttributeSet attributeset, int i)
    {
        ...
        mCentered = attributeset.getBoolean(R.styleable.CirclePageIndicator_centered, flag);
        mOrientation = attributeset.getInt(R.styleable.CirclePageIndicator_android_orientation, l);
        mPaintPageFill.setStyle(android.graphics.Paint.Style.FILL);
        mPaintPageFill.setColor(attributeset.getColor(R.styleable.CirclePageIndicator_pageColor, j));
        mPaintStroke.setStyle(android.graphics.Paint.Style.STROKE);
        mPaintStroke.setColor(attributeset.getColor(R.styleable.CirclePageIndicator_strokeColor, i1));
        mPaintStroke.setStrokeWidth(attributeset.getDimension(R.styleable.CirclePageIndicator_strokeWidth, f));
        mPaintFill.setStyle(android.graphics.Paint.Style.FILL);
        mPaintFill.setColor(attributeset.getColor(R.styleable.CirclePageIndicator_fillColor, k));
        mRadius = attributeset.getDimension(R.styleable.CirclePageIndicator_radius, f1);
        mSnap = attributeset.getBoolean(R.styleable.CirclePageIndicator_snap, flag1);
        obj = attributeset.getDrawable(R.styleable.CirclePageIndicator_android_background);
        if (obj != null)
        {
