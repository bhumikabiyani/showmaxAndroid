    ...
    implements PageIndicator
{
    ...
    public LinePageIndicator(Context context, AttributeSet attributeset, int i)
    {
        ...
        int j = ((Resources) (obj)).getColor(R.color.default_line_indicator_selected_color);
        int k = ((Resources) (obj)).getColor(R.color.default_line_indicator_unselected_color);
        float f = ((Resources) (obj)).getDimension(R.dimen.default_line_indicator_line_width);
        float f1 = ((Resources) (obj)).getDimension(R.dimen.default_line_indicator_gap_width);
        float f2 = ((Resources) (obj)).getDimension(R.dimen.default_line_indicator_stroke_width);
        boolean flag = ((Resources) (obj)).getBoolean(R.bool.default_line_indicator_centered);
        attributeset = context.obtainStyledAttributes(attributeset, R.styleable.LinePageIndicator, i, 0);
        mCentered = attributeset.getBoolean(R.styleable.LinePageIndicator_centered, flag);
        mLineWidth = attributeset.getDimension(R.styleable.LinePageIndicator_lineWidth, f);
        mGapWidth = attributeset.getDimension(R.styleable.LinePageIndicator_gapWidth, f1);
        setStrokeWidth(attributeset.getDimension(R.styleable.LinePageIndicator_strokeWidth, f2));
        mPaintUnselected.setColor(attributeset.getColor(R.styleable.LinePageIndicator_unselectedColor, k));
        mPaintSelected.setColor(attributeset.getColor(R.styleable.LinePageIndicator_selectedColor, j));
        obj = attributeset.getDrawable(R.styleable.LinePageIndicator_android_background);
        if (obj != null)
        {
