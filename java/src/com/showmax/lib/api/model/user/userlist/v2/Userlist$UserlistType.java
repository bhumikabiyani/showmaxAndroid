...
public static final class  extends Enum
{
    ...
    {
        return (allValues)Enum.valueOf(com/showmax/lib/api/model/user/userlist/v2/Userlist$UserlistType, s);
    }
    ...
    {
        switch (com.showmax.lib.api.model.user.userlist.v2.Userlist.UserlistType[ordinal()])
        {
        default:
            return "null";
