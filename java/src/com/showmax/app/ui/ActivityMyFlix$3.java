...
class init> extends ApiCallback
{
    ...
    public void failure(int i)
    {
        ...
        FragmentMyFlixList fragmentmyflixlist = ActivityMyFlix.access$200(ActivityMyFlix.this).getFragmentBookmarks();
        if (isFragmentVisible(fragmentmyflixlist))
        {
            fragmentmyflixlist.showAssets(null, null);
        }
        EventBus.getInstance().post(new ApiErrorEvent(ActivityMyFlix.access$400(ActivityMyFlix.this).getError()));
    }
    ...
    public void success(AssetList assetlist, int i)
    {
        ...
        ActivityMyFlix.access$100(ActivityMyFlix.this).put(com.showmax.lib.api.model.user.userlist.v2.Type.BOOKMARKS, assetlist.items);
        FragmentMyFlixList fragmentmyflixlist = ActivityMyFlix.access$200(ActivityMyFlix.this).getFragmentBookmarks();
        if (isFragmentVisible(fragmentmyflixlist))
        {
