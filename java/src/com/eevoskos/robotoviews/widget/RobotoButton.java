...
public class RobotoButton extends Button
{
    ...
    private void robotize(Context context, AttributeSet attributeset, int i)
    {
        ...
        attributeset = getContext().obtainStyledAttributes(attributeset, com.eevoskos.robotoviews.R.styleable.RobotoButton, i, 0);
        i = attributeset.getInteger(com.eevoskos.robotoviews.R.styleable.RobotoButton_typeface, 0);
