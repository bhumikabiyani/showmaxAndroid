...
public final class ek
{
    ...
    public ek(int i, String s, Map map, long l, boolean flag)
    {
        a = i;
        b = s;
        c = map;
    ...
    public void a(long l)
    {
        f = true;
        g = l - d;
        ja.a(3, "FlurryAgent", (new StringBuilder()).append("Ended event '").append(b).append("' (").append(d).append(") after ").append(g).append("ms").toString());
    }
...
_L1:
        ...
        while (iterator.hasNext()) 
        {
            ...
            ((DataOutputStream) (obj)).writeUTF(je.a((String)entry.getKey()));
            ((DataOutputStream) (obj)).writeUTF(je.a((String)entry.getValue()));
        }
          goto _L1
