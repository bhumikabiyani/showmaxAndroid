...
public final class il
{
    ...
    private static final String a = com/flurry/android/monolithic/sdk/impl/il.getSimpleName();
    ...
    public static PackageInfo a(Context context)
    {
        ...
        if (context != null)
        {
            ...
            {
                ja.a(a, (new StringBuilder()).append("Cannot find package info for package: ").append(context.getPackageName()).toString());
                return null;
            }
        }
        return packageinfo;
    ...
    public static ApplicationInfo b(Context context)
    {
        ...
        if (context != null)
        {
            ...
            {
                ja.a(a, (new StringBuilder()).append("Cannot find application info for package: ").append(context.getPackageName()).toString());
                return null;
            }
        }
