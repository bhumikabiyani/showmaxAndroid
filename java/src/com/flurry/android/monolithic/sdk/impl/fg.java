...
public class fg
{
    ...
    private static final String a = com/flurry/android/monolithic/sdk/impl/fg.getSimpleName();
    private boolean b;
    private List c;
    private long d;
        ...
        throws IOException
    {
        ...
        ja.a(3, a, (new StringBuilder()).append("File version: ").append(i).toString());
        if (i > 2)
        {
            ja.a(6, a, (new StringBuilder()).append("Unknown agent file version: ").append(i).toString());
        ...
        if (i >= 2)
        {
            ...
            ja.a(3, a, (new StringBuilder()).append("Loading API key: ").append(a(s)).toString());
            if (((String) (obj)).equals(s))
            {
                ...
                do
                {
                    ...
                    s.add(0, new ez(((byte []) (obj))));
                    obj = a;
                    StringBuilder stringbuilder = (new StringBuilder()).append("Session report added: ");
                    i++;
                    ja.a(3, ((String) (obj)), stringbuilder.append(i).toString());
                } while (true);
            } else
            {
                ja.a(3, a, (new StringBuilder()).append("Api keys do not match, old: ").append(a(s)).append(", new: ").append(a(((String) (obj)))).toString());
                return false;
            }
        } else
        {
            ja.a(5, a, (new StringBuilder()).append("Deleting old file version: ").append(i).toString());
            return false;
        }
    }
...
_L2:
        ...
        ja.a(6, a, (new StringBuilder()).append("discarded sessions: ").append(i).toString());
...
_L1:
        ...
        throws IOException
    {
        ...
        ja.a(4, a, (new StringBuilder()).append("Magic: ").append(i).toString());
...
_L4:
        ...
        return flag;
_L2:
        ja.a(3, a, "Unexpected file type");
        if (true) goto _L4; else goto _L3
_L3:
        s;
        ja.a(6, a, "Error when loading persistent file", s);
        throw new IOException(s.getMessage());
        s;
        je.a(datainputstream);
        throw s;
