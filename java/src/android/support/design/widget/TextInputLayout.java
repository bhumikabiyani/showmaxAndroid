...
public class TextInputLayout extends LinearLayout
{
    ...
    public TextInputLayout(Context context, AttributeSet attributeset)
    {
        ...
        mLabelTextColor = createLabelTextColorStateList(mCollapsingTextHelper.getCollapsedTextColor());
...
_L3:
    ...
    private ColorStateList createLabelTextColorStateList(int i)
    {
        int ai[][] = new int[2][];
        int ai1[] = new int[2];
        ai[0] = FOCUSED_STATE_SET;
        ai1[0] = i;
        i = 0 + 1;
        ai[i] = EMPTY_STATE_SET;
        ai1[i] = getThemeAttrColor(0x101009a);
    ...
    private void updateLabelVisibility(boolean flag)
    {
        ...
        collapsingtexthelper.setCollapsedTextColor(colorstatelist.getColorForState(ai, mLabelTextColor.getDefaultColor()));
        if (flag1 || flag2)
        {
            collapseHint(flag);
            return;
    ...
    protected void onLayout(boolean flag, int i, int j, int k, int l)
    {
        ...
        mCollapsingTextHelper.onLayout(flag, i, j, k, l);
        if (mEditText != null)
        {
            i = mEditText.getLeft() + mEditText.getPaddingLeft();
            k = mEditText.getRight() - mEditText.getPaddingRight();
            mCollapsingTextHelper.setExpandedBounds(i, mEditText.getTop() + mEditText.getPaddingTop(), k, mEditText.getBottom() - mEditText.getPaddingBottom());
