...
class CircularBorderDrawable extends Drawable
{
    ...
    private Shader createGradientShader()
    {
        ...
        int i = mTopOuterStrokeColor;
        int j = mTopInnerStrokeColor;
        int k = ColorUtils.setAlphaComponent(mTopInnerStrokeColor, 0);
        int l = ColorUtils.setAlphaComponent(mBottomInnerStrokeColor, 0);
        int i1 = mBottomInnerStrokeColor;
        int j1 = mBottomOuterStrokeColor;
