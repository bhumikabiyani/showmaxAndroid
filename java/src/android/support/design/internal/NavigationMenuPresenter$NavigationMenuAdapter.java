...
private class prepareMenuItems extends BaseAdapter
{
    ...
    public View getView(int i, View view, ViewGroup viewgroup)
    {
        ...
        case 0: // '\0'
            ...
            view = (NavigationMenuItemView)view1;
            view.setIconTintList(NavigationMenuPresenter.access$100(NavigationMenuPresenter.this));
            view.setTextColor(NavigationMenuPresenter.access$200(NavigationMenuPresenter.this));
            view.setBackgroundDrawable(NavigationMenuPresenter.access$300(NavigationMenuPresenter.this));
            view.initialize(menuitem.MenuItem(), 0);
            return view1;
