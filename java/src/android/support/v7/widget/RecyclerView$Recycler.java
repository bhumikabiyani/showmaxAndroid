...
public final class mViewCacheMax
{
    ...
    {
        if (RecyclerView.access$4200(RecyclerView.this) != null)
        {
            RecyclerView.access$4200(RecyclerView.this).onViewRecycled(r);
        }
...
_L1:
        ...
        if (((r) (obj)).wasReturnedFromScrap() || ((r) (obj)).getLayoutPosition() != i || ((r) (obj)).isInvalid() || !ess._mth1500(mState) && ((r) (obj)).isRemoved()) goto _L4; else goto _L3
_L3:
...
_L9:
    ...
    View getViewForPosition(int i, boolean flag)
    {
        ...
        if (obj == null)
        {
            ...
            if (k < 0 || k >= RecyclerView.access$2200(RecyclerView.this).etItemCount())
            {
            ...
            int l = RecyclerView.access$2200(RecyclerView.this).etItemViewType(k);
            flag1 = j;
            r = ((r) (obj));
            if (RecyclerView.access$2200(RecyclerView.this).asStableIds())
            {
                obj = getScrapViewForId(RecyclerView.access$2200(RecyclerView.this).etItemId(k), l, flag);
                flag1 = j;
                r = ((r) (obj));
                if (obj != null)
                {
            ...
            if (r1 == null)
            {
                r = RecyclerView.access$2200(RecyclerView.this).reateViewHolder(RecyclerView.this, l);
                k = ((flag1) ? 1 : 0);
            }
        }
        j = 0;
...
label0:
        {
            ...
            flag4 = r.access._mth4000(r);
            boolean flag;
            int i;
            boolean flag1;
            boolean flag2;
            boolean flag3;
            if (RecyclerView.access$2200(RecyclerView.this) != null && flag4 && RecyclerView.access$2200(RecyclerView.this).nFailedToRecycleView(r))
            {
                flag = true;
            } else
            {
