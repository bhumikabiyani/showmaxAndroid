...
public abstract class Draft
{
    ...
    public List continuousFrame(org.java_websocket.framing.Framedata.Opcode opcode, ByteBuffer bytebuffer, boolean flag)
    {
        if (opcode != org.java_websocket.framing.Framedata.Opcode.BINARY && opcode != org.java_websocket.framing.Framedata.Opcode.TEXT && opcode != org.java_websocket.framing.Framedata.Opcode.TEXT)
        {
        ...
        {
            continuousFrameType = org.java_websocket.framing.Framedata.Opcode.CONTINUOUS;
        } else
        {
        ...
        catch (org.java_websocket.framing.Framedata.Opcode opcode)
        {
