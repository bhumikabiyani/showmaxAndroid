...
.method public run()V
    ...
    .line 285
    .local v12, "socket":Ljava/net/ServerSocket;
    ...
    .line 300
    .local v11, "keys":Ljava/util/Set;, "Ljava/util/Set<Ljava/nio/channels/SelectionKey;>;"
    ...
    .end local v11    # "keys":Ljava/util/Set;, "Ljava/util/Set<Ljava/nio/channels/SelectionKey;>;"
    :catch_0
    move-exception v14
    ...
    .end local v12    # "socket":Ljava/net/ServerSocket;
    :catch_1
    move-exception v7
    ...
    .restart local v11    # "keys":Ljava/util/Set;, "Ljava/util/Set<Ljava/nio/channels/SelectionKey;>;"
    .restart local v12    # "socket":Ljava/net/ServerSocket;
    :cond_5
    :try_start_5
    move-object/from16 v0, p0
    ...
    .line 319
    .local v13, "w":Lorg/java_websocket/WebSocketImpl;
    move-object/from16 v0, p0
    ...
    .end local v8    # "i":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/nio/channels/SelectionKey;>;"
    .end local v11    # "keys":Ljava/util/Set;, "Ljava/util/Set<Ljava/nio/channels/SelectionKey;>;"
    .end local v13    # "w":Lorg/java_websocket/WebSocketImpl;
    :catch_2
    move-exception v6
    ...
    .line 396
    .local v13, "w":Lorg/java_websocket/server/WebSocketServer$WebSocketWorker;
    ...
    .end local v13    # "w":Lorg/java_websocket/server/WebSocketServer$WebSocketWorker;
    .restart local v8    # "i":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/nio/channels/SelectionKey;>;"
    .restart local v11    # "keys":Ljava/util/Set;, "Ljava/util/Set<Ljava/nio/channels/SelectionKey;>;"
    :cond_6
    :try_start_6
    ...
    .line 396
    .restart local v13    # "w":Lorg/java_websocket/server/WebSocketServer$WebSocketWorker;
    invoke-virtual {v13}, Lorg/java_websocket/server/WebSocketServer$WebSocketWorker;->interrupt()V
...
.method public stop(I)V
    ...
    .local v2, "socketsToClose":Ljava/util/List;, "Ljava/util/List<Lorg/java_websocket/WebSocket;>;"
    :try_start_1
    monitor-exit v5
    :try_end_1
    ...
    .line 217
    .local v3, "ws":Lorg/java_websocket/WebSocket;
    const/16 v4, 0x3e9
    ...
    .end local v2    # "socketsToClose":Ljava/util/List;, "Ljava/util/List<Lorg/java_websocket/WebSocket;>;"
    .end local v3    # "ws":Lorg/java_websocket/WebSocket;
    ...
    .restart local v2    # "socketsToClose":Ljava/util/List;, "Ljava/util/List<Lorg/java_websocket/WebSocket;>;"
    :cond_1
    monitor-enter p0
